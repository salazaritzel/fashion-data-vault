...
// const sql = postgres(process.env.POSTGRES_URL!, { ssl: 'require' }); // This sql function allows us to query our database.
 

// // Everything below this line is just an example of how you might fetch data from the database. From the Next.js tutorial. We'll do smomething similar above.
...
//     // Promise.all() functions is used to initiate all promises at the same time (parallel data fetching)
