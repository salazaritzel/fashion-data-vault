# Store vocabulary list on here so that it is easily maintainable as it grows (machine learning is the end goal but this will do for now)
materials = [
...
# TODO: Create aliases for some of these brands
fashion_brands = [
    ...
    "DÔEN", "Dolce & Gabbana", "Dsquared2", "Elie Saab", "Emilio Pucci", "Fendi",
    ...
    "Khaite", "Lanvin", "Levi's", "Loewe", "Louis Vuitton", "Luar",
    ...
    "Yohji Yamamoto", "Yves Saint Laurent", "Zac Posen", "Zara", "Zimmermann", "Zuhair Murad"
]

fashion_nouns = [
    "accessory", "bag", "bralette", "cardigan", "corset", "corsetry", "hat", "jewelry", "watch", "earring", "top", "pant",
